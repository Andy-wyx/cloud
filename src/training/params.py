...
def get_default_params(model_name):
    ...
    #else:
    #    return {"lr": 5.0e-4, "beta1": 0.9, "beta2": 0.999, "eps": 1.0e-8}   #default 5.0e-4
    return {"lr": 3.0e-4, "beta1": 0.9, "beta2": 0.98, "eps": 1.0e-6}
...
def parse_args():
    ...
    parser.add_argument(
        "--dataset-type",
        choices=["webdataset", "csv", "auto","COCO","COCO_rpnClipN"],
        default="auto",
